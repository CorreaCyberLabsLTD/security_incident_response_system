...
from security_incident_response_system.notifications.notifiers import Notifier
...
class NotificationsManager:
    ...
    Examples
    --------
    >>> from security_incident_response_system.notifications.notifiers import EmailNotifier
